...
## Project Structure
    ...
    ├── testprivacyapp_dev_29302  # Django project configurations
...
1. Clone this repo and `cd testprivacyapp_dev_29302`
...
2. Clone this repo and `cd testprivacyapp_dev_29302`
